...
const HeroSvg = (props: Props) => {
    return (
        <svg className='w-[750px] h-[750px]' xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 3000 2500" viewBox="0 0 3000 2500" id="computer-coding">
            <rect width="2919.8" height="2442.7" x="40.1" y="28.6" fill="none"></rect><linearGradient id="a" x1="1416.705" x2="782.985" y1="1782.511" y2="2329.95" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#104885">
            </stop>
