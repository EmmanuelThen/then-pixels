    ...
    return (
        <div className=''>
            ...
            <div className='flex flex-col gap-5'>
                {/** First Card */}
                <div className='rounded-b border-b-[0.8px] border-slate4 text-xs lg:text-base p-5'>
                    ...
                    <div className='flex justify-around'>
                        <div className='flex flex-col gap-2 items-center transition duration-150 ease-in-out hover:opacity-80 cursor-pointer'>
                            <svg id='stroke-color' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" className="w-5 h-5 lg:w-10 lg:h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            <p className='lg:text-sm text-center text-slate10'>Terms & Conditions</p>
                        </div>
                        <div className='flex flex-col gap-2 items-center transition duration-150 ease-in-out hover:opacity-80 cursor-pointer'>
                            <svg id='stroke-color' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" className="w-5 h-5 lg:w-10 lg:h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            <p className='lg:text-sm text-center text-slate10'>PixelCare Terms & Conditions</p>
                        </div>
                        <div className='flex flex-col gap-2 items-center transition duration-150 ease-in-out hover:opacity-80 cursor-pointer'>
                            <svg id='stroke-color' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" className="w-5 h-5 lg:w-10 lg:h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            <p className='lg:text-sm text-center text-slate10'>ThenPixels Terms of use</p>
                        </div>
                    </div>
                </div>
                {/** Second Card */}
                <div className='rounded-b border-b-[0.8px] border-slate4 text-xs lg:text-base p-5'>
                    ...
                    <div className='flex justify-around'>
                        <div className='flex flex-col gap-2 items-center justify-center transition duration-150 ease-in-out hover:opacity-80 cursor-pointer'>
                            <svg id='stroke-color' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" className="w-5 h-5 lg:w-10 lg:h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                            <p className='lg:text-sm text-center text-slate10'>Custom</p>
                        </div>
                        <div className='flex flex-col gap-2 items-center justify-center transition duration-150 ease-in-out hover:opacity-80 cursor-pointer'>
                            <svg id='stroke-color' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" className="w-5 h-5 lg:w-10 lg:h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                ...
                {/* Third Card */}
                <div className='text-xs lg:text-base p-2 lg:p-5 rounded shadow-blackA9 shadow-[0px_4px_7px]'>
