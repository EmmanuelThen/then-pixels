...
const GoogleButton = (props: Props) => {
    return (
        <button className="flex gap-8 w-full bg-blue9 text-white hover:bg-[#4285f4]/80 h-[35px] items-center justify-center rounded-[4px] font-medium leading-none focus:outline-none">
