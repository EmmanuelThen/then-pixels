    ...
    <div>
        ...
        >
            <div className="flex items-center">
                <RadioGroup.Item
                    className="hover:cursor-pointer bg-white w-[25px] h-[25px] rounded-full shadow-[0_2px_10px] shadow-blackA7 hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-black outline-none cursor-default"
                    value="5"
                    id="r1"
                >
            ...
            <div className="flex items-center">
                ...
                <label className=" text-[15px] leading-none pl-[15px]" htmlFor="r4">
                    {item4}
                </label>
            </div>
            <div className="flex items-center">
                ...
                <label className=" text-[15px] leading-none pl-[15px]" htmlFor="r5">
                    {item5}
                </label>
            </div>
        </RadioGroup.Root>
